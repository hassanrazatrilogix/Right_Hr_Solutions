...
class Home_Recent(models.Model):
    # Hero Section
    pagename = models.CharField(max_length=255, null=True, blank=True, default="Home")
    hero_title = models.CharField(max_length=255)
    hero_des = models.TextField()
...
class Professional_Services_Recent(models.Model):
    # Hero Section
    pagename = models.CharField(max_length=255, null=True, blank=True)
    hero_title = models.CharField(max_length=255)
    hero_text = models.TextField()
...
class Hr_Solutions_Recent(models.Model):
    # Hero Section
    pagename = models.CharField(max_length=255, null=True, blank=True)
    hero_title = models.CharField(max_length=255)
    hero_text = models.TextField()
...
class Government_Recent(models.Model):
    # Hero Section
    pagename = models.CharField(max_length=255, null=True, blank=True)
    hero_title = models.CharField(max_length=255)
    hero_text = models.TextField()
...
class About_Us_Recent(models.Model):
    # Hero Section
